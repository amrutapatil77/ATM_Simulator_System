...
public class SignUp2 extends JFrame implements ActionListener{
	...
	SignUp2()
	{
		...
		int x=fm.stringWidth("NEW A[PPLICATION FORM PAGE 2");
		...
		l1=new JLabel("Page 2:Additionl Details");
        ...
        r1.setFont(new Font("Ralewat",Font.BOLD,14));
        r1.setBackground(Color.WHITE);
        
        r2=new JRadioButton("No");
        r2.setFont(new Font("Ralewat",Font.BOLD,14));
        ...
        r3.setFont(new Font("Ralewat",Font.BOLD,14));
		...
		String c=(String)c3.getSelectedItem();
         ...
         try {
        	 ...
        	 if(t2.getText().equals(""))
        	 {
        		 ...
        		 conn c1=new conn();
        		 String q1="insert into signup2 valuse('"+a+"','"+b+"','"+c+"','"+d+"','"+e+"','"+f+"','"+g+"','"+h+"','"+i+"','"+j+"')";
